...
class TestConversion(MultiChainTestCase):
    ...
    def test_encoding_decoding_signature(self):
        ...
        message = meta.impl(distribution=(self.community.claim_global_time(),),
                            payload=tuple(block.generate_signature()))
        # Act
        ...
        # Assert
        self.assertEqual_signature(block, result)
    ...
    def test_split_function(self):
        ...
        self.assertEqual(block.total_up, values[2])
        self.assertEqual(block.total_down, values[3])
