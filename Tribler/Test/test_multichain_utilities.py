...
class TestBlock:
    ...
    def __init__(self):
        ...
        self.total_up_requester = random.randint(241, 260)
        self.total_down_requester = random.randint(261, 280)
        self.total_up_responder = random.randint(281, 300)
        self.total_down_responder = random.randint(301, 320)
